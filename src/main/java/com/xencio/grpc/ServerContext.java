...
public class ServerContext {
    ...
    private final MyGrpcSerializeService defaultSerializeService;
    ...
    ServerContext(Channel channel, MyGrpcSerializeService serializeService) {
    ...
    public GrpcResponse handle(SerializeType serializeType, GrpcRequest grpcRequest) {
        MyGrpcSerializeService serializeService = SerializeUtils.getSerializeService(serializeType, this.defaultSerializeService);
